...
public partial class HeThongChiaSeTaiLieu_V1 : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        if (!optionsBuilder.IsConfigured)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=DESKTOPPPRE7540\\PHUNGVANVU;Initial Catalog=SHAREDOCS;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
        }
    }
